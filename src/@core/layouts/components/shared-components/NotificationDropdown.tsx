  ...
  return (
    <Fragment>
        ...
        >
          <Avatar
          alt={ 'asd'}
          aria-haspopup='true' onClick={handleDropdownOpen} aria-controls='customized-menu'
          sx={{ width: 40, height: 40 , backgroundColor:theme.palette.customColors.darkBg, color:'white',cursor: 'pointer'}}
